...
VALUES ($1,$2,$3,$4,$5,$6) RETURNING account_name, bank, bank_code, balance, type_of_account, id`;
...
const findAccountByAccountId = `
SELECT id, account_name, bank, bank_code, balance, type_of_account  FROM accounts WHERE id=$1
`;
